...
export default function AddItem({ item }: { item: Precios }) {
  ...
  return (
    <div className="flex flex-col sm:flex-row w-full shadow bg-indigo-200 rounded-xl px-4 py-4 gap-3 items-stretch justify-between mb-3">
      {/* Controles de cantidad */}
      <div className="w-full sm:w-24">
        <div className="flex bg-slate-200 hover:bg-slate-100 rounded-lg py-2 gap-3 items-center justify-center">
          <button
